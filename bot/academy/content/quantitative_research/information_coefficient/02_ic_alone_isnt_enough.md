...
Quant Bot Pro's research pipeline checks both, separately, on purpose:
...
Quant Bot Pro's `validated_feature_registry.py` records exactly this outcome for the strategy that relies on RSI:
